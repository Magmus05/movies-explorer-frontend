...
function AboutProject() {
  return (
    <section className="aboutproject container" id="AboutProject">
      <h2 className="aboutproject__title ">О проекте</h2>
      <div className="aboutproject__description ">
        <h3 className="aboutproject__description-title el1">
          Дипломный проект включал 5 этапов
        </h3>
        <h3 className="aboutproject__description-title el2">
          На выполнение диплома ушло 5 недель
        </h3>
        <p className="aboutproject__description-text el3">
          Составление плана, работу над бэкендом, вёрстку, добавление
          функциональности и финальные доработки.
        </p>
        <p className="aboutproject__description-text el4">
